...
namespace WingSlot {
    internal class WingSlotPlayer : ModPlayer {
        ...
        //    Item wings = WingSlotUI.EquipSlot.Item;
        //    Item vanityWings = VanitySlot.Item;

        //    if(wings.stack > 0) {
        //        player.VanillaUpdateAccessory(player.whoAmI, wings, !WingSlotUI.EquipSlot.ItemVisible, ref wallSpeedBuff, ref tileSpeedBuff,
        //            ref tileRangeBuff);
        ...
        //        { HiddenTag, WingSlotUI.EquipSlot.ItemVisible },
        //        { WingsTag, ItemIO.Save(WingSlotUI.EquipSlot.Item) },
        ...
        //    WingSlotUI.EquipSlot.ItemVisible = tag.GetBool(HiddenTag);
        //}
        ...
        //    ui?.EquipSlot.Left.Set(rX, ui.Left.Percent);
        //    ui?.EquipSlot.Top.Set(rY, ui.EquipSlot.Top.Percent);
        //    //ui?.EquipSlot.Draw(spriteBatch);

        //    //WingSlotUI.EquipSlot.Position = new Vector2(rX, rY);
