...
namespace TerraUI.Objects {
    public class UICheckBox : UIObject {
        ...
        public UICheckBox(Vector2 position, int width, SpriteFont font, string text = "", bool defaultValue = false, UIObject parent = null)
        ...
        /// <param name="defaultValue">default value of the check box</param>
        /// <param name="parent">parent UIObject</param>
        public UICheckBox(Vector2 position, int width, int boxHeight, SpriteFont font, string text = "", bool defaultValue = false,
